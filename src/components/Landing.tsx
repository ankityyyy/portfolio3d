...
//  import CharacterModel from "./Character"; // <-- Import 3D Character
  ...
  return (
    <section className="landing-section" id="landingDiv">
      ...
      <div className="social-sidebar">
        ...
        <a href="https://linkedin.com/in/ankitkumardubey" target="_blank" rel="noreferrer">
          <FaLinkedin />
        </a>
   ...
   <div className="landing-container">
        ...
        <div className="landing-left">
          ...
          <p className="description">
            I build scalable web applications and AI-powered
